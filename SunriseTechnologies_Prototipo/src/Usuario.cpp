...
void Usuario::cargar(){
    ...
    cout << "INGRESE EL TIPO DE PERMISO(1:SISTEMAS, 2:RESERVA, 3:CHECK-IN, 4:ENCOMIENDAS):";
    cin >> _permiso;
    while(_permiso!=1 && _permiso!=2 && _permiso!=3 && _permiso!=4){
        cout << "PERMISO ERRONEO " << endl;
        cout << "REINGRESE EL TIPO DE PERMISO(1:SISTEMAS, 2:RESERVA, 3:CHECK-IN, 4:ENCOMIENDAS):";
        cin >> _permiso;
        cin.ignore();
    }
}
