...
void menuVuelos(){
    ...
    do{
        ...
        gotoxy(4, 9);
        cout << "4-REGISTRAR VUELOS DE ENCOMIENDAS" <<endl;
        gotoxy(4, 10);
        cout << "0-SALIR" << endl;
        gotoxy(4, 11);
        cout << "--> ";
...
void menuEncomiendas(){
    ...
    do{
        cls();
        gotoxy(4, 4);
        cout << "MENÚ ENCOMIENDAS" << endl;
        gotoxy(4, 5);
        cout << "-------------" << endl;
        gotoxy(4, 6);
        cout << "1-INGRESAR CLIENTE" << endl;
        gotoxy(4, 7);
        cout << "2-INGRESAR PAQUETE" << endl;
        gotoxy(4, 8);
        cout << "3-CONFIRMAR DESPACHO" << endl;
        gotoxy(4, 9);
        cout << "4-MOSTRAR TICKET DE DESPACHO" << endl;
        gotoxy(4, 10);
        cout << "5-PROMEDIO DE PESO POR VUELO" << endl;
        gotoxy(4, 11);
        cout << "0-SALIR" << endl;
        gotoxy(4, 12);
        cout << "--> ";
